...
varTYPE=DOUBLE
capLetter=D
varList=(pftauchhads_IP1D_val pftauchhads_IP1D_err pftauchhads_IP1D_sig pftauchhads_sIP1D_val pftauchhads_sIP1D_err pftauchhads_sIP1D_sig)
...
varLast=pftauchhads_sIP1D_sig
varNum='int(pftauchhads_num)'
varCount=p
#Print info
echo " "
#Declare variables
